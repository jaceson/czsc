...
def main():
    ...
    # 计算配置
    daily_config = {'mline':False,'minion':False,'chaodi':False,'golden':True,'strong':False,'strategy':False,'buypoint':False,'chan':False,'bigfish':False,'oversold_rebound':False,'newhigh30min':True}
    # 获取当前日期
