...
# df = pd.read_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V2.xlsx")
...
# # df.to_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V2.xlsx", index=False)


# df['60分钟'] = df['60分钟'].fillna(method='bfill')
# df['120分钟'] = df['120分钟'].fillna(method='bfill')
# df.to_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V3.xlsx", index=False)

# df = pd.read_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V3.xlsx")
...
def main():
    ...
    df.to_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V4.xlsx", index=False)

    df = pd.read_excel(r"~\Desktop\Users\zengb\Desktop\time_split_conf_V4.xlsx")
