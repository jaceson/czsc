...
def init_config(context):
    ...
    files_position1 = [
        r"~\Desktop\趋势研究\完全分类\15分钟趋势突破海龟1策略多60#10#60分钟完全分类16#10.json",
        r"~\Desktop\趋势研究\完全分类\15分钟趋势突破海龟1策略多60#10#日线完全分类16#10.json",

    ]

    files_position2 = [
        r"~\Desktop\趋势研究\完全分类\15分钟趋势突破海龟1策略多60#10#日线完全分类9#60.json",
        r"~\Desktop\趋势研究\完全分类\15分钟趋势突破海龟1策略多60#10#日线完全分类9#120.json",
    ]
