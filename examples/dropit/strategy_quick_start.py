...
if __name__ == '__main__':
    ...
    trader = tactic.replay(bars, sdt='20200101', res_path=r"~\Desktop\策略研究\测试1')
    ...
    db = DummyBacktest(strategy=CzscStocksBeta, signals_path=r"~\Desktop\策略研究\signals',
                       results_path=r"~\Desktop\策略研究\CzscStocksBetaV2', read_bars=research.get_raw_bars)
