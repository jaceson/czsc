...
gjm = {
        # trader 缓存目录
        'cache_path': "~\Desktop\国金QMT交易端模拟\userdata_mini\czsc_stocks_beta_cache",
        # mini qmt 目录
        'mini_qmt_dir': "~\Desktop\国金QMT交易端模拟\userdata_mini",
        # 账户id
        'account_id': '55002763',
        # 设定实盘交易的股票池
        ...
        'callback_params': {
            ...
            'log_file': "~\Desktop\国金QMT交易端模拟\userdata_mini\czsc_stocks_beta_cache\czsc_stocks_beta.log',
        },
}
